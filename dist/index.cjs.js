...
var StyledButton = styled__default['default'].button(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["\n  align-items: center;\n  background-color: ", ";\n  border: ", ";\n  border-radius: 5px;\n  box-shadow: ", ";\n  color: ", ";\n  cursor: pointer;\n  display: inline-flex;\n  font-family: inherit;\n  font-size: 16px;\n  font-weight: 600;\n  /* max-content instead of auto for Safari fix */\n  width: ", ";\n  height: ", ";\n  line-height: 1;\n  letter-spacing: 0.03em;\n  justify-content: center;\n  outline: 0;\n  padding: ", ";\n  transition: background-color 0.2s;\n  opacity: ", ";\n\n  &:hover:not(:disabled):not(.button--disabled):not(:active) {\n    background-color: ", ";\n    border-color: ", ";\n  }\n\n  &:focus:not(:active) {\n    box-shadow: 0 0 0 2px ", ";\n  }\n\n  &:active {\n    background-color: ", ";\n    box-shadow: ", ";\n  }\n\n  ", "\n  ", "\n  ", "\n"], ["\n  align-items: center;\n  background-color: ", ";\n  border: ", ";\n  border-radius: 5px;\n  box-shadow: ", ";\n  color: ", ";\n  cursor: pointer;\n  display: inline-flex;\n  font-family: inherit;\n  font-size: 16px;\n  font-weight: 600;\n  /* max-content instead of auto for Safari fix */\n  width: ", ";\n  height: ", ";\n  line-height: 1;\n  letter-spacing: 0.03em;\n  justify-content: center;\n  outline: 0;\n  padding: ", ";\n  transition: background-color 0.2s;\n  opacity: ", ";\n\n  &:hover:not(:disabled):not(.button--disabled):not(:active) {\n    background-color: ", ";\n    border-color: ", ";\n  }\n\n  &:focus:not(:active) {\n    box-shadow: 0 0 0 2px ", ";\n  }\n\n  &:active {\n    background-color: ", ";\n    box-shadow: ", ";\n  }\n\n  ", "\n  ", "\n  ", "\n"])), getButtonVariantProp("background"), getButtonVariantProp("border"), getButtonVariantProp("boxShadow"), getButtonVariantProp("color"), function (_a) {
    ...
    var size = _a.size;
    return (size === "sm" ? "30px" : "38px");
}, function (_a) {
    var size = _a.size;
    return (size === "sm" ? "0 14px" : "0 20px");
}, function (_a) {
...
var Icon$q = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props), "asd"));
};
...
var Icon$w = function (props) {
    return (React__default['default'].createElement("img", { style: { marginRight: "10px", width: "26px", height: "26px" }, src: "data:image/png;base64," }));
};
...
var Rotate = styled__default['default'].div(templateObject_2$7 || (templateObject_2$7 = __makeTemplateObject(["\n  display: inline-block;\n  animation: ", " 2s linear infinite;\n  padding: 2rem 1rem;\n  font-size: 1.2rem;\n"], ["\n  display: inline-block;\n  animation: ", " 2s linear infinite;\n  padding: 2rem 1rem;\n  font-size: 1.2rem;\n"])), rotate$1);
...
var Spinner = function (_a) {
    ...
    return (React__default['default'].createElement(Container$1, null,
        React__default['default'].createElement(Rotate, null,
            React__default['default'].createElement("svg", { xmlSpace: "preserve", viewBox: "0 0 100 100", y: 0, x: 0, xmlns: "http://www.w3.org/2000/svg", id: "\u5716\u5C64_1", version: "1.1", width: "104px", height: "104px", xmlnsXlink: "http://www.w3.org/1999/xlink" },
                React__default['default'].createElement("g", { className: "ldl-scale" },
                    React__default['default'].createElement("path", { fill: "#849b87", d: "M26.7 63.7l5.7-9.9 9.9 5.7L32.8 37 8.6 40l9.9 5.7-5.8 10c-.5.9-.5 2.1 0 3l11.2 19.4c.5.9 1.5 1.5 2.6 1.5h21v-16H26.7z", style: {
                            fill: "rgb(132, 155, 135)",
                        } }),
                    React__default['default'].createElement("path", { fill: "#f8b26a", d: "M87.7 55.4L77.2 37.2l-13.9 8 10.4 18.1H62.3V51.8L47.7 71.3l14.7 19.5V79.3H74c1.1 0 2.1-.6 2.6-1.5l11.2-19.4c.5-.9.5-2.1-.1-3z", style: {
                            fill: "rgb(248, 178, 106)",
                        } }),
                    React__default['default'].createElement("path", { fill: "#abbd81", d: "M69.5 24.6l-5.8-10c-.5-.9-1.5-1.5-2.6-1.5H38.7c-1.1 0-2.1.6-2.6 1.5L25.6 32.7l13.9 8 10.4-18.1 5.7 9.9-9.9 5.7 24.2 3 9.5-22.4-9.9 5.8z", style: {
...
var shadows = {
    ...
    focus: "0px 0px 4px 3px rgba(57,156,107,1)",
...
var Icon$P = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 510 510" }, props),
        React__default['default'].createElement("g", null,
            React__default['default'].createElement("path", { d: "m90 0c-24.813 0-45 20.187-45 45v420c0 24.813 20.187 45 45 45h375v-30h-30v-30h30c0-15.786 0-431.133 0-450-14.55 0-359.712 0-375 0zm0 30h15v390h-15c-5.258 0-10.305.915-15 2.58v-377.58c0-8.271 6.729-15 15-15zm315 450h-315c-19.904-.826-19.889-29.181 0-30h315zm-270-60v-390h300v390z" }),
            React__default['default'].createElement("path", { d: "m300 181.557v-31.557h30c33.084 0 60-26.916 60-60v-30h-60c-17.908 0-33.997 7.896-45 20.377-11.003-12.481-27.092-20.377-45-20.377h-60v30c0 33.084 26.916 60 60 60h30v31.557c-48.13 10.101-56.602 58.249-56.712 58.443h-48.288v30h240v-30h-48.288c-.3-.529-7.991-48.219-56.712-58.443zm30-91.557h30c0 16.542-13.458 30-30 30h-30c0-16.542 13.458-30 30-30zm-90 30c-16.542 0-30-13.458-30-30h30c16.542 0 30 13.458 30 30zm45 90c18.8 0 35.209 12.222 40.712 30h-81.424c5.503-17.778 21.912-30 40.712-30z" }),
            React__default['default'].createElement("path", { d: "m165 360h120v30h-120z" }),
            React__default['default'].createElement("path", { d: "m165 300h240v30h-240z" }),
            React__default['default'].createElement("path", { d: "m315 360h90v30h-90z" }))));
};
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 160 26" }, props), "hello"));
};
...
var Icon$U = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 74 74" }, props),
        React__default['default'].createElement("g", null,
            React__default['default'].createElement("path", { d: "m47.979 72h-21.958a4 4 0 0 1 -4-4v-20a4 4 0 0 1 4-4h21.958a4 4 0 0 1 4 4v20a4 4 0 0 1 -4 4zm-21.958-26a2 2 0 0 0 -2 2v20a2 2 0 0 0 2 2h21.958a2 2 0 0 0 2-2v-20a2 2 0 0 0 -2-2z" }),
            React__default['default'].createElement("path", { d: "m47.7 32.882h-21.4a4.279 4.279 0 1 1 0-8.559h21.4a4.279 4.279 0 1 1 0 8.559zm-21.4-6.558a2.279 2.279 0 1 0 0 4.559h21.4a2.279 2.279 0 1 0 0-4.559z" }),
            React__default['default'].createElement("path", { d: "m47.7 39.441h-21.4a4.28 4.28 0 0 1 0-8.559h21.4a4.28 4.28 0 0 1 0 8.559zm-21.4-6.559a2.28 2.28 0 0 0 0 4.559h21.4a2.28 2.28 0 0 0 0-4.559z" }),
            React__default['default'].createElement("path", { d: "m47.7 46h-21.4a4.279 4.279 0 1 1 0-8.559h21.4a4.279 4.279 0 1 1 0 8.559zm-21.4-6.559a2.279 2.279 0 1 0 0 4.559h21.4a2.279 2.279 0 1 0 0-4.559z" }),
            React__default['default'].createElement("path", { d: "m47.979 26.324h-21.958a4 4 0 0 1 -4-4v-2.006a3.991 3.991 0 0 1 1.043-2.693l8.169-8.967h11.535l8.169 8.967a3.994 3.994 0 0 1 1.043 2.694v2.005a4 4 0 0 1 -4.001 4zm-15.864-15.666-7.573 8.313a2 2 0 0 0 -.521 1.347v2.005a2 2 0 0 0 2 2h21.958a2 2 0 0 0 2-2v-2.005a2 2 0 0 0 -.521-1.348l-7.573-8.313z" }),
            React__default['default'].createElement("path", { d: "m44.522 10.658h-15.044a2.068 2.068 0 0 1 -2.065-2.065v-4.528a2.068 2.068 0 0 1 2.065-2.065h15.044a2.068 2.068 0 0 1 2.065 2.065v4.528a2.068 2.068 0 0 1 -2.065 2.065zm-15.044-6.658-.065.065v4.528l15.11.065.065-4.592z" }))));
};
...
var Icon$Y = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 22.16 22.16" }, props),
        React__default['default'].createElement("g", { "data-name": "Camada 2", id: "Camada_2" },
            React__default['default'].createElement("g", { "data-name": "Camada 1", id: "Camada_1-2" },
                React__default['default'].createElement("path", { d: "M4.35,7.79A2.2,2.2,0,0,0,5.2,8v.48a.16.16,0,0,0,0,.12.16.16,0,0,0,.12,0h.43a.16.16,0,0,0,.12,0,.16.16,0,0,0,0-.12V8a2.05,2.05,0,0,0,1.16-.45,1.22,1.22,0,0,0,.43-1,1.2,1.2,0,0,0-.17-.67,1.27,1.27,0,0,0-.53-.43,4.79,4.79,0,0,0-1-.31A5.36,5.36,0,0,1,5.19,5a.89.89,0,0,1-.34-.22.46.46,0,0,1-.11-.31A.47.47,0,0,1,5,4a1.06,1.06,0,0,1,.6-.14A1,1,0,0,1,6.12,4a.56.56,0,0,1,.27.37.2.2,0,0,0,.2.12h.65a.14.14,0,0,0,.14-.14,1.1,1.1,0,0,0-.18-.52,1.53,1.53,0,0,0-.49-.47A1.9,1.9,0,0,0,6,3.14V2.65a.15.15,0,0,0-.17-.17H5.36a.16.16,0,0,0-.12,0,.16.16,0,0,0,0,.12v.48a1.8,1.8,0,0,0-1.06.45,1.21,1.21,0,0,0-.39.91,1.12,1.12,0,0,0,.38.91,2.92,2.92,0,0,0,1.19.51q.49.13.74.22a1,1,0,0,1,.38.22.42.42,0,0,1,.12.31.51.51,0,0,1-.24.44,1.31,1.31,0,0,1-.72.16,1.22,1.22,0,0,1-.67-.16.74.74,0,0,1-.32-.39.31.31,0,0,0-.09-.1.22.22,0,0,0-.13,0H3.77a.15.15,0,0,0-.11,0,.14.14,0,0,0,0,.1,1.16,1.16,0,0,0,.2.6A1.44,1.44,0,0,0,4.35,7.79Z" }),
                React__default['default'].createElement("path", { d: "M5.58,11.16A5.58,5.58,0,1,0,0,5.58,5.59,5.59,0,0,0,5.58,11.16ZM5.58,1A4.57,4.57,0,1,1,1,5.58,4.57,4.57,0,0,1,5.58,1Z" }),
                React__default['default'].createElement("path", { d: "M17.84,16.52a4.75,4.75,0,0,0-1-.31,5.29,5.29,0,0,1-.68-.21.89.89,0,0,1-.34-.22.46.46,0,0,1-.11-.31.47.47,0,0,1,.22-.42,1.06,1.06,0,0,1,.6-.14,1,1,0,0,1,.57.15.56.56,0,0,1,.27.37.2.2,0,0,0,.2.12h.65a.14.14,0,0,0,.14-.14,1.1,1.1,0,0,0-.18-.52,1.53,1.53,0,0,0-.49-.47,1.91,1.91,0,0,0-.77-.27v-.49a.15.15,0,0,0-.17-.17h-.43a.17.17,0,0,0-.12,0,.16.16,0,0,0,0,.12v.47a1.81,1.81,0,0,0-1.06.45,1.21,1.21,0,0,0-.39.91,1.12,1.12,0,0,0,.38.91,2.93,2.93,0,0,0,1.19.51q.49.13.74.22a1,1,0,0,1,.38.22.42.42,0,0,1,.12.31.51.51,0,0,1-.24.44,1.31,1.31,0,0,1-.72.16,1.22,1.22,0,0,1-.67-.16.74.74,0,0,1-.32-.39.32.32,0,0,0-.09-.1.22.22,0,0,0-.13,0h-.62a.14.14,0,0,0-.11,0,.14.14,0,0,0,0,.1,1.16,1.16,0,0,0,.2.6,1.45,1.45,0,0,0,.54.47,2.22,2.22,0,0,0,.85.24v.48a.16.16,0,0,0,0,.12.17.17,0,0,0,.12,0h.43a.15.15,0,0,0,.17-.17V19a2.05,2.05,0,0,0,1.16-.45,1.22,1.22,0,0,0,.43-1,1.19,1.19,0,0,0-.17-.67A1.27,1.27,0,0,0,17.84,16.52Z" }),
                React__default['default'].createElement("path", { d: "M16.59,11a5.58,5.58,0,1,0,5.58,5.58A5.58,5.58,0,0,0,16.59,11Zm0,10.15a4.57,4.57,0,1,1,4.57-4.57A4.57,4.57,0,0,1,16.59,21.15Z" }),
                React__default['default'].createElement("path", { d: "M13,6.09h7.41L19.12,7.4a.51.51,0,0,0,.72.72L22,5.94h0a.49.49,0,0,0,.14-.35.51.51,0,0,0,0-.19A.52.52,0,0,0,22,5.22L19.83,3a.51.51,0,0,0-.72.72l1.32,1.32H13a.51.51,0,1,0,0,1Z" }),
                React__default['default'].createElement("path", { d: "M9.14,16.08H1.73L3,14.76A.51.51,0,0,0,2.33,14L.15,16.23a.5.5,0,0,0-.11.16.5.5,0,0,0,0,.39.5.5,0,0,0,.1.16h0l2.18,2.18A.51.51,0,1,0,3,18.41L1.73,17.09H9.14a.51.51,0,0,0,0-1Z" })))));
};
...
var StyledLogo = styled__default['default'](Text)(templateObject_2$b || (templateObject_2$b = __makeTemplateObject(["\n  display: flex;\n  aligh-items: center;\n  img {\n    width: 30px;\n    height: 30px;\n    ", " {\n      width: 46px;\n      height: 46px;\n    }\n  }\n  span {\n    font-weight: normal;\n    font-family: Mansalva;\n    font-size: 19px;\n    margin-left: 5px;\n    ", " {\n      font-size: 28px;\n      margin-left: 15px;\n    }\n  }\n"], ["\n  display: flex;\n  aligh-items: center;\n  img {\n    width: 30px;\n    height: 30px;\n    ", " {\n      width: 46px;\n      height: 46px;\n    }\n  }\n  span {\n    font-weight: normal;\n    font-family: Mansalva;\n    font-size: 19px;\n    margin-left: 5px;\n    ", " {\n      font-size: 28px;\n      margin-left: 15px;\n    }\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.md;
}, function (_a) {
    var theme = _a.theme;
...
var links = [
    ...
    },
    {
        ...
        items: [
            ...
            {
                label: "Github",
                href: "https://github.com/recyclefinance",
            },
            {
                label: "Docs",
...
var socials = [
    {
        ...
        items: [
            {
                label: "English",
                href: "https://t.me/recyclefinancedefi",
            },
        ],
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/recyclefinance",
    },
];
var MENU_HEIGHT = 64;
...
var templateObject_1$E, templateObject_2$e, templateObject_3$7, templateObject_4$2;
...
var Menu = function (_a) {
    var _b;
    var account = _a.account, login = _a.login, logout = _a.logout, isDark = _a.isDark, toggleTheme = _a.toggleTheme, langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang, cakePriceUsd = _a.cakePriceUsd, links = _a.links, priceLink = _a.priceLink, children = _a.children;
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#d9f0e1", inputSecondary: "#d7caec", tertiary: "#EFF4F5", text: "#0B2C7B", textDisabled: "#BDC2C4", textSubtle: "#1992ae", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#9A6AFF", background: "#101713", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#2a4d3c", inputSecondary: "#66578D", primaryDark: "#0098A1", tertiary: "#353547", text: "#EAE2FC", textDisabled: "#666171", textSubtle: "#0EC5F0", borderColor: "#524B63", card: "#27262c", gradients: {
